...
|名稱|簡介|
|---|---|
|[Neo Store](https://f-droid.org/zh_Hant/packages/com.machiav3lli.fdroid/)|內建許多第三方套件庫的F-Droid客戶端，Droidfy的後繼者。|
...
|[小企鵝 Fcitx5 for Android](https://github.com/fcitx5-android/fcitx5-android)|移植自Linux系統的輸入法，支援拼音、注音、倉頡、嘸蝦米等輸入方案。提供簡繁轉換（包括OpenCC），紀錄剪貼簿歷史，打字會積極的提示Emoji，可以自訂主題。|
...
|[Ripple](https://f-droid.org/packages/info.guardianproject.ripple/)|點選之後會自動清除指定APP的資料。|
