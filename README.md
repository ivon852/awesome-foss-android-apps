...
自由軟體即程式原始碼可見，使用者有執行、檢閱、修改、散佈程式的自由。使用者能確認APP背後的運作原理。F-Droid幾乎沒有Google Play的熱門APP，遑論大多數「不自由」的手機遊戲。但是，使用者將會發現，許多好用的APP，能夠在不犧牲自由、隱私、安全的前提下使用。例如瀏覽器、檔案管理器、影片播放器這類常用APP，大多數都是免費無廣告，更棒的是他們是自由開源的。 

如果不想依賴Google Play或中國的應用程式商店，並且想尋找「開源、無廣告、免費」的APP，那麼以下列表值得您參考。點選藍色字可直接前往下載頁面。

請善用右邊的目錄快速跳轉。Github可以點選README右上角的三個點顯示目錄。

文中提及的APP以F-Droid的連結為主，若無則放原始碼儲存庫連結。這些APP可以在[F-Droid](https://ivonblog.com/posts/what-is-f-droid/)這個開源應用程式商店取得，有些要額外加入套件庫才能下載。

如果APP沒上架F-Droid，又不想手動下載APK，您也可以透過[Obtainium](https://ivonblog.com/posts/use-obtainium-to-download-foss-apps/)來追蹤各大網站發表的APK更新。真的不行再使用Google Play吧。

您可以到[Weblate](https://hosted.weblate.org/projects/f-droid/)參與翻譯有在F-Droid上架APP的中文說明。
...
|名稱|簡介|
|---|---|
|[Neo Store](https://f-droid.org/zh_Hant/packages/com.machiav3lli.fdroid/)|內建許多第三方套件庫的F-Droid客戶端。|
|[Droid-ify](https://f-droid.org/zh_Hant/packages/com.looker.droidify/)|列表式的第三方F-Droid客戶端，支援Shizuku安裝。|
...
|[Accrescent](https://github.com/accrescent/accrescent)|GrapheneOS推出的應用程式商店，強調隱私保護。|


## 瀏覽器

Android手機的瀏覽器陣營，大致可以分為Chromium系(Blink)與Firefox系(Gecko)。

|名稱|簡介|
|---|---|
|[Mozilla Firefox](https://hg-edge.mozilla.org/mozilla-central)| Firefox官方手機版，使用Gecko排版引擎，支援安裝擴充功能與同步電腦版帳號資料。也可以充當密碼管理器，自動填入其他APP的密碼。因為Mozilla不願意在F-Droid上架，也停止在Github發佈APK了，所以F-Droid只有Firefox的fork。如果你想使用官方版Firefox，得透過Obtainium來追蹤APK更新。|
|[Fennec F-Droid](https://f-droid.org/en/packages/org.mozilla.fennec_fdroid/)|基於Firefox (Fenix) 開發，強調隱私保護，去掉了Firefox的追蹤器和專有函式庫。支援登入Mozilla帳號同步。|
|[IronFox](https://gitlab.com/ironfox-oss/IronFox)|基於Firefox開發，Mull的後繼者，預設啟用了很多隱私保護設定，強大到許多網站會因此壞掉。支援登入Mozilla帳號同步。|
...
|[Titanium Browser](https://github.com/jqssun/android-titanium-browser)|基於Chromium開發的瀏覽器，融合了GrapheneOS的Vanadium瀏覽器強化隱私的patch，與電腦版Helium瀏覽器patch的修改版。支援在Android手機安裝電腦版Chrome的擴充套件。|
...
|名稱|簡介|
|---|---|
|[Adaway](https://f-droid.org/zh_Hant/packages/org.adaway/)|擋廣告APP，需要Root權限，透過改/etc/hosts來全域擋廣告。無Root也可以使用，改為透過本機DNS來攔阻。|
...
|[OpenVPN](https://github.com/schwabe/ics-openvpn)|OpenVPN協定官方Android版客戶端。|
|[WireGuard](https://git.zx2c4.com/wireguard-android/about/)|WireGuard協定官方Android版客戶端。|
...
|[NetBird](https://github.com/netbirdio/android-client)|內網穿透軟體。|
...
|名稱|簡介|
|---|---|
|[質感檔案 Material Files](https://f-droid.org/zh_Hant/packages/me.zhanghai.android.files/)|質感設計風格的簡易檔案管理員，支援解壓縮、文字編輯、查看圖片、連接FTP與SMB伺服器，有免Root存取Android/data目錄的能力。採用Material Desgin設計的簡單檔案管理器。雖然不支援雙重面板，不過可以長按上方路徑開啟第二視窗，方便在多個資料夾之間移動檔案。|
...
|名稱|簡介|
|---|---|
| [Simplenote](https://github.com/automattic/simplenote-android) | 跨平台Markdown筆記軟體，有網頁版。可以把筆記公開成網頁。 |
...
|[Aves Libre](https://f-droid.org/packages/deckers.thibault.aves.libre/)|Flutter寫成的相簿APP，支援檢視圖片、影片、地圖資訊。|
...
|[OuterTune](https://f-droid.org/en/packages/com.dd3boh.outertune/)|無廣告聆聽Youtube Music，支援播放歌詞、Android Auto。InnerTune精神的繼承者。|
...
|[PixEz Flutter](https://github.com/Notsfsssf/pixez-flutter)|跨平台Pixiv客戶端，支援查看動圖和以圖搜圖。|
|[Pixiv-Shaft](https://github.com/CeuiLiSA/Pixiv-Shaft)|第三方Pixiv客戶端。|
|[Legado](https://github.com/gedoor/legado)|線上電子書閱讀器。|
|[木之子漫畫閱讀器 Kinoko Manga Reader](https://f-droid.org/zh_Hant/packages/com.ero.kinoko/)|支援多個線上漫畫平台，可閱覽或下載漫畫。|
|[Mihon](https://github.com/mihonapp/mihon)|Tachiyomi繼承者，免費漫畫閱讀器，可以線上瀏覽與下載漫畫，支援多個線上平台。有非常多的分支版本，|
|[EhViewer overhauled](https://github.com/FooIbar/EhViewer)|採用Material You設計的E-hentai閱讀器。|
...
|[Streamflix](https://github.com/streamflix-reborn/streamflix)|Android TV專用APP，觀看戲劇專用。|
...
|[Find My Device（FMD）](https://f-droid.org/zh_Hant/packages/de.nulide.findmydevice/)| 不依賴Google服務的「尋找我的裝置」APP，可以遠端鎖定裝置。 |
...
|[HeliBoard](https://f-droid.org/zh_Hant/packages/helium314.keyboard/)|可以自訂主題的Material You風格英文鍵盤。|
|[中州韻 TRIME](https://f-droid.org/zh_Hant/packages/com.osfans.trime/)|支援強大自定義配置的中文輸入法框架，使用RIME引擎。內建的是朙月拼音，注音使用者請使用「洋蔥注音輸入方案」。提供簡轉繁、切換全形半形、剪貼簿、Emoji、日文、韓文、俄文等多樣化的符號輸入。|
...
|[Ripple](https://f-droid.org/packages/info.guardianproject.ripple/)|在緊急的時候使用，點選之後會自動清除指定APP的資料。|
|[Duress](https://github.com/x13a/Duress)|設定一組特殊的解鎖密碼，在緊急的時候使用，觸發了就會清除手機資料。|
|[Wasted](https://github.com/x13a/Wasted)|利用裝置管理員的權限，遠端鎖定與清除手機資料。|
|[CPU Info](https://f-droid.org/zh_Hant/packages/com.kgurgul.cpuinfo/)|檢視手機CPU頻率與溫度。|
|[CPU Stats](https://github.com/takke/cpustats)|檢視CPU各個核心使用率與頻率的APP。|
...
|[SD Maid 2/SE](https://github.com/d4rken-org/sdmaid-se)|系統垃圾清理軟體，尋找重複檔案。|
|[Shizuku](https://github.com/RikkaApps/Shizuku)|免電腦免Root，讓APP使用ADB Shell指令。|
