...
|[Simple File Manager Pro](https://f-droid.org/zh_Hant/packages/com.simplemobiletools.filemanager.pro/)|簡易檔案管理員。|
|[Ghost Commander](https://f-droid.org/zh_Hant/packages/com.simplemobiletools.filemanager.pro/)|有二個面板的檔案管理器，方便對照檔案。類似Total Commander。|
...
|名稱|簡介|
|---|---|
|[VLC](https://f-droid.org/zh_Hant/packages/org.videolan.vlc/)|支援各種影片/音樂格式的播放器，可在背景播放影片，或當成音樂播放器使用。|
|[mpv-android](https://f-droid.org/en/packages/is.xyz.mpv/)|MPV影片/音樂播放器Android版。|
...
|[Wifi Camera](https://f-droid.org/zh_Hant/packages/teaonly.droideye/)|用Wifi分享手機鏡頭給電腦瀏覽器使用。|
|[Simple Gallery Pro](https://f-droid.org/zh_Hant/packages/com.simplemobiletools.gallery.pro/)|相簿APP，可簡單編輯相片，類似快圖瀏覽。|
...
|[Tachiyomi](https://staging.f-droid.org/en/packages/eu.kanade.tachiyomi/)|漫畫閱讀器，亦支援多個線上平台。|
...
|名稱|簡介|
|---|---|
|[Minetest](https://f-droid.org/zh_Hant/packages/net.minetest.minetest/)|自由開源的沙盒遊戲，有大量模組可安裝。如果F-Droid的APK無法啟動，請改到官網下載APK。|
|[SuperTuxKart](https://f-droid.org/zh_Hant/packages/org.supertuxkart.stk/)|自由軟體相關吉祥物駕駛卡丁車的賽車遊戲，畫面品質還不錯。|
...
|[Shattered Pixel Dungeon](https://f-droid.org/zh_Hant/packages/com.shatteredpixel.shatteredpixeldungeon/)|Pixel Dungeon的衍生版本。|
...
|[Lemuroid](https://f-droid.org/zh_Hant/packages/com.swordfish.lemuroid/)|基於Libretro開發，Atari、SEGA、Nitendo等遊戲主機的模擬器。|
...
|[J2ME Loader](https://f-droid.org/zh_Hant/packages/ru.playsoftware.j2meloader/)| 讓您在Android手機玩古早Java小遊戲。 |
...
|[Simple Calendar Pro](https://f-droid.org/zh_Hant/packages/com.simplemobiletools.calendar.pro/)|簡易離線月曆APP，可用日月年檢視行程。|
|[Simple Clock](https://f-droid.org/zh_Hant/packages/com.simplemobiletools.clock/)|簡易時鐘APP。|
